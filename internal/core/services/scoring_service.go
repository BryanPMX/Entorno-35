...
// CalculateAssessmentWithCompany calculates the score for an assessment with company authorization
func (s *ScoringService) CalculateAssessmentWithCompany(assessmentID uuid.UUID, companyID uuid.UUID) error {
	// Fetch assessment with company validation (for authorization)
