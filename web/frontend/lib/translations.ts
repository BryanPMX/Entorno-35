...
export const translations = {
  ...
  billing: {
    ...
    refundDescription: "Envia una solicitud para que soporte revise un posible reembolso de cobro reciente.",
    refundReasonLabel: "Motivo del reembolso",
    refundReasonPlaceholder: "Describe el motivo y el contexto del cobro que deseas reembolsar.",
    refundSubmit: "Enviar Solicitud",
    refundSubmitting: "Enviando solicitud...",
    refundSuccess: "Solicitud de reembolso enviada. Soporte revisara tu caso y te contactara por correo.",
    refundDuplicate: "Ya existe una solicitud de reembolso abierta para tu empresa.",
    ...
    supportHint: "Si Stripe indica un conflicto de suscripcion o necesitas seguimiento de facturacion, contacta soporte.",
  },
